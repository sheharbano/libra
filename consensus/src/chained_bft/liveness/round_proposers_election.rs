...
impl RoundProposers {
    ...
    fn get_proposers(&self, round: Round) -> Vector<Author> {
        match self.proposers {
            ...
            Some(ref map) => {
                ...
                // proposers
                match map.contains(round) {
                    None => vec![self.default_proposer],
                    Some(ref round_proposers) => round_proposers
                },
            },
        }
    }
