...
impl ::protobuf::ProtobufEnum for VMInvariantViolationError {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<VMInvariantViolationError> {
        match value {
            ...
            10 => ::std::option::Option::Some(VMInvariantViolationError::EventKeyMismatch),
            _ => ::std::option::Option::None
        }
    }
    ...
    fn values() -> &'static [Self] {
        static values: &'static [VMInvariantViolationError] = &[
            ...
            VMInvariantViolationError::EventKeyMismatch,
        ];
        values
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x13\n\x0fNoModuleHandles\x10F*\x8d\x02\n\x19VMInvariantViolationError\
