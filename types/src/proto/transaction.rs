...
impl RawTransaction {
    ...
    // .types.Script script = 8;


    pub fn get_script(&self) -> &Script {
        match self.payload {
            ::std::option::Option::Some(RawTransaction_oneof_payload::script(ref v)) => v,
    ...
    pub fn has_script(&self) -> bool {
        match self.payload {
            ::std::option::Option::Some(RawTransaction_oneof_payload::script(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_script(&mut self, v: Script) {
        self.payload = ::std::option::Option::Some(RawTransaction_oneof_payload::script(v))
    }

    // Mutable pointer to the field.
    pub fn mut_script(&mut self) -> &mut Script {
        if let ::std::option::Option::Some(RawTransaction_oneof_payload::script(_)) = self.payload {
        } else {
            self.payload = ::std::option::Option::Some(RawTransaction_oneof_payload::script(Script::new()));
        }
        match self.payload {
            ::std::option::Option::Some(RawTransaction_oneof_payload::script(ref mut v)) => v,
            _ => panic!(),
        }
    }
    ...
    pub fn take_script(&mut self) -> Script {
        if self.has_script() {
            match self.payload.take() {
                ::std::option::Option::Some(RawTransaction_oneof_payload::script(v)) => v,
                _ => panic!(),
            }
        } else {
            Script::new()
    ...
    // .types.Module module = 9;


    pub fn get_module(&self) -> &Module {
        match self.payload {
            ::std::option::Option::Some(RawTransaction_oneof_payload::module(ref v)) => v,
            _ => Module::default_instance(),
        }
    }
    ...
    pub fn has_module(&self) -> bool {
        match self.payload {
            ::std::option::Option::Some(RawTransaction_oneof_payload::module(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_module(&mut self, v: Module) {
        self.payload = ::std::option::Option::Some(RawTransaction_oneof_payload::module(v))
    }

    // Mutable pointer to the field.
    pub fn mut_module(&mut self) -> &mut Module {
        if let ::std::option::Option::Some(RawTransaction_oneof_payload::module(_)) = self.payload {
        } else {
            self.payload = ::std::option::Option::Some(RawTransaction_oneof_payload::module(Module::new()));
        }
        match self.payload {
            ::std::option::Option::Some(RawTransaction_oneof_payload::module(ref mut v)) => v,
            _ => panic!(),
        }
    }
    ...
    pub fn take_module(&mut self) -> Module {
        if self.has_module() {
            match self.payload.take() {
                ::std::option::Option::Some(RawTransaction_oneof_payload::module(v)) => v,
                _ => panic!(),
            }
        } else {
            Module::new()
...
impl ::protobuf::Message for RawTransaction {
    fn is_initialized(&self) -> bool {
        ...
        if let Some(RawTransaction_oneof_payload::script(ref v)) = self.payload {
            if !v.is_initialized() {
                return false;
            }
        }
        if let Some(RawTransaction_oneof_payload::module(ref v)) = self.payload {
            if !v.is_initialized() {
                return false;
            }
        }
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                8 => {
                    ...
                    self.payload = ::std::option::Option::Some(RawTransaction_oneof_payload::script(is.read_message()?));
                },
                9 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self.payload = ::std::option::Option::Some(RawTransaction_oneof_payload::module(is.read_message()?));
                },
                5 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.payload {
            match v {
                ...
                &RawTransaction_oneof_payload::script(ref v) => {
                    let len = v.compute_size();
                    my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
                },
                &RawTransaction_oneof_payload::module(ref v) => {
                    let len = v.compute_size();
                    my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
                },
            };
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_message_accessor::<_, Script>(
                    "script",
                    RawTransaction::has_script,
                    RawTransaction::get_script,
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_message_accessor::<_, Module>(
                    "module",
                    RawTransaction::has_module,
                    RawTransaction::get_module,
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint64>(
                    "max_gas_amount",
...
impl ::protobuf::Message for Script {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new::<Script>(
                    "Script",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static Script {
        static mut instance: ::protobuf::lazy::Lazy<Script> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const Script,
        };
        unsafe {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    /protobuf/wrappers.proto\"\x8e\x03\n\x0eRawTransaction\x12%\n\x0esender_\
    ...
    \x08\x20\x01(\x0b2\r.types.ScriptH\0R\x06script\x12'\n\x06module\x18\t\
    \x20\x01(\x0b2\r.types.ModuleH\0R\x06module\x12$\n\x0emax_gas_amount\x18\
    \x05\x20\x01(\x04R\x0cmaxGasAmount\x12$\n\x0egas_unit_price\x18\x06\x20\
    \x01(\x04R\x0cgasUnitPrice\x12'\n\x0fexpiration_time\x18\x07\x20\x01(\
    \x04R\x0eexpirationTimeB\t\n\x07payload\"q\n\x07Program\x12\x12\n\x04cod\
    e\x18\x01\x20\x01(\x0cR\x04code\x128\n\targuments\x18\x02\x20\x03(\x0b2\
    \x1a.types.TransactionArgumentR\targuments\x12\x18\n\x07modules\x18\x03\
    \x20\x03(\x0cR\x07modules\"V\n\x06Script\x12\x12\n\x04code\x18\x01\x20\
    \x01(\x0cR\x04code\x128\n\targuments\x18\x02\x20\x03(\x0b2\x1a.types.Tra\
    nsactionArgumentR\targuments\"\x9d\x01\n\x13TransactionArgument\x126\n\
    \x04type\x18\x01\x20\x01(\x0e2\".types.TransactionArgument.ArgTypeR\x04t\
    ype\x12\x12\n\x04data\x18\x02\x20\x01(\x0cR\x04data\":\n\x07ArgType\x12\
    \x07\n\x03U64\x10\0\x12\x0b\n\x07ADDRESS\x10\x01\x12\n\n\x06STRING\x10\
    \x02\x12\r\n\tBYTEARRAY\x10\x03\"\x1c\n\x06Module\x12\x12\n\x04code\x18\
    \x01\x20\x01(\x0cR\x04code\"\x8e\x01\n\x11SignedTransaction\x12\"\n\rraw\
    _txn_bytes\x18\x01\x20\x01(\x0cR\x0brawTxnBytes\x12*\n\x11sender_public_\
    key\x18\x02\x20\x01(\x0cR\x0fsenderPublicKey\x12)\n\x10sender_signature\
    \x18\x03\x20\x01(\x0cR\x0fsenderSignature\"\xdf\x01\n\x1aSignedTransacti\
    onWithProof\x12\x18\n\x07version\x18\x01\x20\x01(\x04R\x07version\x12G\n\
    \x12signed_transaction\x18\x02\x20\x01(\x0b2\x18.types.SignedTransaction\
    R\x11signedTransaction\x123\n\x05proof\x18\x03\x20\x01(\x0b2\x1d.types.S\
    ignedTransactionProofR\x05proof\x12)\n\x06events\x18\x04\x20\x01(\x0b2\
    \x11.types.EventsListR\x06events\"\xba\x01\n\x17SignedTransactionsBlock\
    \x12<\n\x0ctransactions\x18\x01\x20\x03(\x0b2\x18.types.SignedTransactio\
    nR\x0ctransactions\x120\n\x14validator_public_key\x18\x02\x20\x01(\x0cR\
    \x12validatorPublicKey\x12/\n\x13validator_signature\x18\x03\x20\x01(\
    \x0cR\x12validatorSignature\"7\n\x08WriteSet\x12+\n\twrite_set\x18\x01\
    \x20\x03(\x0b2\x0e.types.WriteOpR\x08writeSet\"{\n\x07WriteOp\x122\n\x0b\
    access_path\x18\x01\x20\x01(\x0b2\x11.types.AccessPathR\naccessPath\x12\
    \x14\n\x05value\x18\x02\x20\x01(\x0cR\x05value\x12&\n\x04type\x18\x03\
    \x20\x01(\x0e2\x12.types.WriteOpTypeR\x04type\"<\n\x0cAccountState\x12\
    \x18\n\x07address\x18\x01\x20\x01(\x0cR\x07address\x12\x12\n\x04blob\x18\
    \x02\x20\x01(\x0cR\x04blob\"\xcb\x01\n\x13TransactionToCommit\x127\n\nsi\
    gned_txn\x18\x01\x20\x01(\x0b2\x18.types.SignedTransactionR\tsignedTxn\
    \x12:\n\x0eaccount_states\x18\x02\x20\x03(\x0b2\x13.types.AccountStateR\
