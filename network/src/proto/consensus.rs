...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    MsgH\0R\ntimeoutMsg\x120\n\tsync_info\x18\x06\x20\x01(\x0b2\x11.network.\
    SyncInfoH\0R\x08syncInfoB\t\n\x07message\"q\n\x08Proposal\x125\n\x0eprop\
    osed_block\x18\x01\x20\x01(\x0b2\x0e.network.BlockR\rproposedBlock\x12.\
    \n\tsync_info\x18\x02\x20\x01(\x0b2\x11.network.SyncInfoR\x08syncInfo\"\
    \x81\x01\n\x10PacemakerTimeout\x12\x14\n\x05round\x18\x01\x20\x01(\x04R\
    \x05round\x12\x16\n\x06author\x18\x02\x20\x01(\x0cR\x06author\x12\x1c\n\
    \tsignature\x18\x03\x20\x01(\x0cR\tsignature\x12!\n\x04vote\x18\x04\x20\
    \x01(\x0b2\r.network.VoteR\x04vote\"\xa2\x01\n\nTimeoutMsg\x12.\n\tsync_\
    info\x18\x01\x20\x01(\x0b2\x11.network.SyncInfoR\x08syncInfo\x12F\n\x11p\
    acemaker_timeout\x18\x02\x20\x01(\x0b2\x19.network.PacemakerTimeoutR\x10\
    pacemakerTimeout\x12\x1c\n\tsignature\x18\x03\x20\x01(\x0cR\tsignature\"\
    \xec\x01\n\x08SyncInfo\x12C\n\x13highest_quorum_cert\x18\x01\x20\x01(\
    \x0b2\x13.network.QuorumCertR\x11highestQuorumCert\x12C\n\x13highest_led\
    ger_info\x18\x02\x20\x01(\x0b2\x13.network.QuorumCertR\x11highestLedgerI\
    nfo\x12V\n\x14highest_timeout_cert\x18\x03\x20\x01(\x0b2$.network.Pacema\
    kerTimeoutCertificateR\x12highestTimeoutCert\"j\n\x1bPacemakerTimeoutCer\
    tificate\x12\x14\n\x05round\x18\x01\x20\x01(\x04R\x05round\x125\n\x08tim\
    eouts\x18\x02\x20\x03(\x0b2\x19.network.PacemakerTimeoutR\x08timeouts\"\
    \x91\x02\n\x05Block\x12\x0e\n\x02id\x18\x01\x20\x01(\x0cR\x02id\x12\x1b\
    \n\tparent_id\x18\x02\x20\x01(\x0cR\x08parentId\x12\x18\n\x07payload\x18\
    \x03\x20\x01(\x0cR\x07payload\x12\x14\n\x05round\x18\x04\x20\x01(\x04R\
    \x05round\x12\x16\n\x06height\x18\x05\x20\x01(\x04R\x06height\x12'\n\x0f\
    timestamp_usecs\x18\x06\x20\x01(\x04R\x0etimestampUsecs\x124\n\x0bquorum\
    _cert\x18\x07\x20\x01(\x0b2\x13.network.QuorumCertR\nquorumCert\x12\x16\
    \n\x06author\x18\x08\x20\x01(\x0cR\x06author\x12\x1c\n\tsignature\x18\t\
    \x20\x01(\x0cR\tsignature\"\x81\x03\n\nQuorumCert\x12\x19\n\x08block_id\
    \x18\x01\x20\x01(\x0cR\x07blockId\x12\x19\n\x08state_id\x18\x02\x20\x01(\
    \x0cR\x07stateId\x12\x18\n\x07version\x18\x03\x20\x01(\x04R\x07version\
    \x12\x14\n\x05round\x18\x04\x20\x01(\x04R\x05round\x12M\n\x12signed_ledg\
    er_info\x18\x05\x20\x01(\x0b2\x1f.types.LedgerInfoWithSignaturesR\x10sig\
    nedLedgerInfo\x12&\n\x0fparent_block_id\x18\x06\x20\x01(\x0cR\rparentBlo\
    ckId\x12,\n\x12parent_block_round\x18\x07\x20\x01(\x04R\x10parentBlockRo\
    und\x120\n\x14grandparent_block_id\x18\x08\x20\x01(\x0cR\x12grandparentB\
    lockId\x126\n\x17grandparent_block_round\x18\t\x20\x01(\x04R\x15grandpar\
    entBlockRound\"\xb8\x03\n\x04Vote\x12*\n\x11proposed_block_id\x18\x01\
    \x20\x01(\x0cR\x0fproposedBlockId\x12*\n\x11executed_state_id\x18\x02\
    \x20\x01(\x0cR\x0fexecutedStateId\x12\x18\n\x07version\x18\x03\x20\x01(\
    \x04R\x07version\x12\x14\n\x05round\x18\x04\x20\x01(\x04R\x05round\x12\
    \x16\n\x06author\x18\x05\x20\x01(\x0cR\x06author\x122\n\x0bledger_info\
    \x18\x06\x20\x01(\x0b2\x11.types.LedgerInfoR\nledgerInfo\x12\x1c\n\tsign\
    ature\x18\x07\x20\x01(\x0cR\tsignature\x12&\n\x0fparent_block_id\x18\x08\
    \x20\x01(\x0cR\rparentBlockId\x12,\n\x12parent_block_round\x18\t\x20\x01\
    (\x04R\x10parentBlockRound\x120\n\x14grandparent_block_id\x18\n\x20\x01(\
    \x0cR\x12grandparentBlockId\x126\n\x17grandparent_block_round\x18\x0b\
    \x20\x01(\x04R\x15grandparentBlockRound\"H\n\x0cRequestBlock\x12\x19\n\
    \x08block_id\x18\x01\x20\x01(\x0cR\x07blockId\x12\x1d\n\nnum_blocks\x18\
    \x02\x20\x01(\x04R\tnumBlocks\"m\n\x0cRespondBlock\x125\n\x06status\x18\
    \x01\x20\x01(\x0e2\x1d.network.BlockRetrievalStatusR\x06status\x12&\n\
    \x06blocks\x18\x02\x20\x03(\x0b2\x0e.network.BlockR\x06blocks*N\n\x14Blo\
    ckRetrievalStatus\x12\r\n\tSUCCEEDED\x10\0\x12\x10\n\x0cID_NOT_FOUND\x10\
    \x01\x12\x15\n\x11NOT_ENOUGH_BLOCKS\x10\x02b\x06proto3\
";
